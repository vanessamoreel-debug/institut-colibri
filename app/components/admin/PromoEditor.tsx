...
type Initial = { promoActive: boolean; promoText: string };
...
export default function PromoEditor({ initial }: { initial: Initial }) {
  ...
  function clearText() { setPromoText(""); }
  ...
  return (
    <div className="card p-6 space-y-6">
      ...
      <div className="flex gap-3">
        <button onClick={save} disabled={saving} className="px-4 py-2 bg-[var(--brand)] text-white rounded disabled:opacity-60">
